...
static int
uct_sci_ipc_iface_is_reachable_v2(const uct_iface_h tl_iface,
                                   const uct_iface_is_reachable_params_t *params)
{
    return 0;
}

int uct_sci_ipc_ep_is_connected(const uct_ep_h tl_ep,
...
static uct_iface_internal_ops_t uct_base_iface_internal_ops = {
    ...
    .iface_is_reachable_v2 = uct_sci_ipc_iface_is_reachable_v2,
...
static UCS_CLASS_CLEANUP_FUNC(uct_sci_iface_t)
{
    ...
    */
    ...
    /* RX  */
    uct_sci_helper_remove_seg_set_unavail(self->local_segment, self->local_segment);
